...
#define ASSERT(cond, msg, file, line) ((cond) ? ((void)0) : __custom_assert(#cond, __FILE__, __LINE__))
#else
#define ASSERT(cond, msg, file, line) ((cond) ? ((void)0) : __custom_assert(msg, file, line))
#endif
